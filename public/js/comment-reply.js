$(document).ready(function () {
	...
	CommentFormHandler.prototype = {
		toggleVisibility: function (wrap) {
			var self = this;
	...
	CommentFactory.prototype = {
		...
		answerFormShow: function (target) {
